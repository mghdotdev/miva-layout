...
/***/ "./node_modules/lodash.pull/index.js":
/*!*******************************************!*\
  !*** ./node_modules/lodash.pull/index.js ***!
  \*******************************************/
/*! no static exports found */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MivaLayout; });
...
/* harmony import */ var lodash_pull__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lodash.pull */ "./node_modules/lodash.pull/index.js");
...
/*#__PURE__*/
function () {
  function MivaLayout(layout) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck(this, MivaLayout);
    ...
    this.options = Object.assign({}, defaultOptions, options); // assign layout argument to private property

    this.$layout = lodash_clonedeep__WEBPACK_IMPORTED_MODULE_1___default()(layout); // create finalized components structure

    this.components = new _MivaLayoutComponentTree__WEBPACK_IMPORTED_MODULE_0__["default"](layout); // find "config" component - remove from tree if found

    this.config = this._findConfigComponent(this.components); // create flat version
  ...
  _createClass(MivaLayout, [{
    ...
    key: "_findConfigComponent",
    value: function _findConfigComponent(componentTree) {
      if (!(componentTree instanceof _MivaLayoutComponentTree__WEBPACK_IMPORTED_MODULE_0__["default"])) {
        throw new TypeError('[MivaLayout] - "componentTree" is not a MivaLayoutComponentTree instance');
      }

      var configComponent = componentTree.type(this.options.configComponentCode);

      if (configComponent != undefined) {
        if (this.options.pullConfigComponent) {
          lodash_pull__WEBPACK_IMPORTED_MODULE_4___default()(componentTree, configComponent[0]);
        }
      ...
      if (!this.options.suppressWarnings) {
        console.warn("[MivaLayout] - unable to find configuration component \"".concat(this.options.configComponentCode, "\""));
      }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MivaLayoutComponent; });
/* harmony import */ var _MivaLayoutComponentTree__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MivaLayoutComponentTree */ "./src/MivaLayoutComponentTree.js");
...
var MivaLayoutComponent =
/*#__PURE__*/
function () {
  function MivaLayoutComponent(component) {
    _classCallCheck(this, MivaLayoutComponent);
    ...
    this.childrenCount = component.children_count == undefined ? 0 : component.children_count; // special attributes structure

    this.attributes = this._createAttributes(component.attributes); // special children structure

    this.children = new _MivaLayoutComponentTree__WEBPACK_IMPORTED_MODULE_0__["default"](component.children);
  }
  /* ================================ Public Methods ================================ */
  ...
  _createClass(MivaLayoutComponent, [{
    key: "_createAttributes",
    value: function _createAttributes(attributes) {
      var _this = this;

      if (_typeof(attributes) == 'object') {
        return Object.keys(attributes).reduce(function (modifiedAttrs, attrKey) {
          var formattedAttrKey = lodash_camelCase__WEBPACK_IMPORTED_MODULE_1___default()(attrKey);

          return _objectSpread({}, modifiedAttrs, _defineProperty({}, formattedAttrKey, _this._formatAttributeValue(attributes[attrKey])));
        }, {});
      }
    ...
    value: function _formatAttributeValue(attribute) {
      if (attribute.value == '' || attribute.value == ':id=0' && attribute.product != undefined || attribute.value == ':id=0' && attribute.category != undefined) {
        return null;
      } else {
...
/***/ "./src/MivaLayoutComponentTree.js":
/*!****************************************!*\
  !*** ./src/MivaLayoutComponentTree.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MivaLayoutComponentTree; });
/* harmony import */ var _MivaLayoutComponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MivaLayoutComponent */ "./src/MivaLayoutComponent.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var MivaLayoutComponentTree =
/*#__PURE__*/
function (_Array) {
  _inherits(MivaLayoutComponentTree, _Array);

  function MivaLayoutComponentTree(components) {
    var _getPrototypeOf2;

    var _this;

    _classCallCheck(this, MivaLayoutComponentTree);

    var list = [];

    if (Array.isArray(components)) {
      list = components.reduce(function (components, component) {
        return components.concat(new _MivaLayoutComponent__WEBPACK_IMPORTED_MODULE_0__["default"](component));
      }, []);
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(MivaLayoutComponentTree)).call.apply(_getPrototypeOf2, [this].concat(_toConsumableArray(list))));
  ...
  _createClass(MivaLayoutComponentTree, [{
    ...
    value: function id(_id) {
      ...
      return this._findBy('id', _id);
    }
  }, {
    key: "componentId",
    value: function componentId(_componentId) {
      if (typeof _componentId != 'number') {
        throw new TypeError('[MivaLayoutComponentTree] - "componentId" is not a number');
      }

      return this._groupBy('componentId', _componentId);
    }
  }, {
    key: "type",
    value: function type(_type) {
      if (typeof _type != 'number' && typeof _type != 'string') {
        throw new TypeError('[MivaLayoutComponentTree] - "type" is not a number or string');
      }

      return this._groupBy('type', _type);
    }
  }, {
    key: "typeName",
    value: function typeName(_typeName) {
      if (typeof _typeName != 'number' && typeof _typeName != 'string') {
        throw new TypeError('[MivaLayoutComponentTree] - "typeName" is not a number or string');
      }

      return this._groupBy('typeName', _typeName);
    }
  }, {
    key: "name",
    value: function name(_name) {
      if (typeof _name != 'number' && typeof _name != 'string') {
        throw new TypeError('[MivaLayoutComponentTree] - "name" is not a number or string');
      }

      return this._groupBy('name', _name);
    }
    /* ================================ Private Methods ================================ */

  }, {
    key: "_findBy",
    value: function _findBy(findKey, findVal) {
    ...
    key: "_findByRecursion",
    value: function _findByRecursion(findKey, findVal, components) {
      for (var i = 0; i < components.length; i++) {
        if (components[i][findKey] == findVal) {
          return components[i];
        } else if (components[i].childrenCount) {
          var found = this._findByRecursion(findKey, findVal, components[i].children);
    ...
    key: "_groupBy",
    value: function _groupBy(groupKey, groupVal) {
      ...
      var result = this._groupByRecursion(groupKey, groupVal, this);

      return result.length > 0 ? result : undefined;
    }
  }, {
    key: "_groupByRecursion",
    value: function _groupByRecursion(groupKey, groupVal, components) {
      var _this2 = this;

      return components.reduce(function (groupedComponents, currentComponent) {
        return groupedComponents.concat(currentComponent[groupKey] == groupVal ? currentComponent : [], _this2._groupByRecursion(groupKey, groupVal, currentComponent.children));
      }, []);
    }
  }]);

  return MivaLayoutComponentTree;
